    ...
    $(document).ready(function(){                         
        ...
        $("#validar_upd").click(function(){
            ...
            $("#mostrar_validar_upd").delay(15).queue(function(n) {                                                 
                $.ajax({
                    type: "POST",
                    url: "./funciones/mod4_ri_agenda_param_ajax_validar_upd.php",                                                                                                                                                                                                    
    ...
    $(document).ready(function(){                         
        ...
        $("#validar_del").click(function(){
            ...
            $("#mostrar_validar_del").delay(15).queue(function(n) {                                                 
                $.ajax({
                    type: "POST",
                    url: "./funciones/mod4_ronda_inv_ajax_validar_del_procAg.php",                                                                                                                                                                                                    
                    data: "id="+id,     
                    dataType: "html",
                    error: function(){	        alert("error petición ajax");           		},
    ...
    $(document).ready(function(){                         
        ...
        $("#validar_proc").click(function(){
            ...
            $("#mostrar_validar_proc").delay(15).queue(function(n) {                                                 
                $.ajax({
                    type: "POST",
                    url: "./funciones/mod4_ri_agenda_ajax_validar_proc.php",                                                                                                                                                                                                    
                    data: "id="+id+"&usu="+usu,     
                    dataType: "html",
                    error: function(){	        alert("error petición ajax");           		    },
    ...
    $(document).ready(function(){                         
        ...
        $("#validar_ver").click(function(){
            ...
            $("#mostrar_validar_ver").delay(15).queue(function(n) {                                                 
                $.ajax({
                    type: "POST",
                    url: "./funciones/mod4_ri_agenda_ajax_validar_ver.php",                                                                                                                                                                                                    
                    data: "id="+id+"&usu="+usu,     
                    dataType: "html",
                    error: function(){	        alert("error petición ajax");                   },
                ...
                <div class="middle-content container-xxl p-0">
                            ...
                            <form name="form_del_user" id="form_del_user" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">
                                        <div class="row">
                                            <label> La función permite administrar las Agendas de las Rondas de Inversiones. </label>
                                            <br/>
                                        </div><br>							
                                    </div><br /> 
                                </div>	
                    ...
                    <div id="modal_ver" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-content" >
                            ...
                            <div class="modal-header"><h6 class="modal-title"><i class="bi bi-search" style="font-size: 1rem;"></i>  Ver Agenda </h6></div>
                    ...
                    <div id="modal_procesar" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-content" >
                            ...
                            <div class="modal-header"><h6 class="modal-title"><i class="bi bi-magic" style="font-size: 1rem;"></i> Procesar Agenda </h6></div>
                    ...
                    <div id="modal_del" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-content" >
                            ...
                            <div class="modal-header"><h6 class="modal-title"><i class="bi bi-trash" style="font-size: 1rem;"></i> Borrar Agenda </h6></div>
                            ...
                            <form name="form_del_reg" id="form_del_reg" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                ...
                                <div class="modal-footer d-flex center-content-end"><center>					
                                    <button class="btn btn-dark" data-bs-dismiss="modal" tabindex="2">Cancelar</button>		                                    
                                    <button id="validar_del" name="validar_del" type="button" class="btn btn-danger" title="Se va a validar si se puede borrar." tabindex="3"> Eliminar </button>
                                    <br /><br />
                    ...
                    <div id="modal_add" class="modal animated fadeInDown" tabindex="-1" role="dialog" >
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-header"><h6 class="modal-title"> Agregar Sector </h6></div>
                    ...
                    <div id="modal_upd" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-header"><h6 class="modal-title"><i class="bi bi-pencil" style="font-size: 1rem;"></i> Modificar Parametros </h6></div>
                            ...
                            <form name="mdf_reg" id="mdf_reg" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                ...
                                <div class="modal-footer"><center>					
                                    <button type="button" class="btn btn-dark" onclick="window.location.href='./_ronda_inv_agenda.php'" tabindex="3" onclick="reiniciarFormulario()"> Cancelar </button>
                                    <!-- <button class="btn btn-dark" data-bs-dismiss="modal" tabindex="4">Cancelar</button> -->
