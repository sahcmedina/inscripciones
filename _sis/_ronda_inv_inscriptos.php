...
$(document).ready(function(){                         
    ...
    $("#inscriptos").change(function(e){
        ...
        $("#resultado_busqueda").delay(700).queue(function(n) {                                                 
            $.ajax({
            type: "POST",
            url: "./funciones/mod4_ronda_inv_ajax_buscar_inscript.php",
            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <nav class="breadcrumb-style-five" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item">Ronda de Inversiones</li>
                            ...
                            <div class="modal-header"><h6 class="modal-title"> Información </h6></div>
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">
                                        <div class="row">
                                            <center><label><i class="icon-warning"></i> La función permite administrar los inscriptos a las Rondas de Inversiones </label></center>
                                        </div><br>
                                    </div><br /> 
                                </div>	
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="alert-text">
                                    <strong> <h6> Listado de Inscriptos a las Rondas de Inversiones </h6> </strong> 
                                </div>
                            </div>
                            <div class="alert-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="inscriptos">Seleccione el evento para ver los Inscriptos</label>
                            <select id="inscriptos" name="inscriptos" class="form-select form-control-sm" tabindex="1" required>
                                ...
                                <?php
							        ...
							        for ($i = 0; $i < count($arr_rondas); $i++)
								        echo '<option value="'.$arr_rondas[$i]['id'].'"'.'>' .$arr_rondas[$i]['nombre']. "</option>\n";
							    ?>	  
                            </select>
                        </div>
                    </div>
