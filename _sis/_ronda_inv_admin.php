<?php
    ...
    $arr_sect= array();
    $arr_sect= $Sectores->gets();

    $entidad = 'Ronda de Inversiones';
?>
...
<head>
    ...
    $(document).ready(function(){  
        $('#modal_upd').on('show.bs.modal', function (event) {    
            ...
            var modal     = $(this)
            modal.find('.modal-body #id_ri').val(id)
    ...
    $("#validar_del").click(function(){
		id = $("#id_del").val();			
	  	...
	  	$("#mostrar_validar_del").delay(15).queue(function(n) {                                                 
            $.ajax({
                type: "POST",
                url: "./funciones/mod4_ronda_inv_ajax_validar_del.php",                                                                                                                                                                                                    
                data: "id="+id,     
              	dataType: "html",
                error: function(){	        alert("error petición ajax");           		},
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="alert-text">
                                    <strong> <h6> Listado de Rondas de Inversiones </h6> </strong> 
                                </div>
                            </div>
                            <div class="alert-btn">
                                <?php if($alta == '1') { ?>
                                    <button data-bs-toggle="modal" data-bs-target="#modal_add_ri" class="btn btn-outline-success btn-icon mb-2 me-4 btn-sm" title="Agregar un nuevo Foro" ><i class="bi bi-plus-circle" style="font-size: 1rem;"></i></button>                                        
                                <?php } ?>
                            ...
                            <form name="form_del_user" id="form_del_user" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">
                                        <div class="row">
                                            <label><i class="icon-warning"></i> La función permite administrar Rondas de Inversiones. Altas, bajas y modificaciones de la RI que se mostrar en la web. </label>
                                            <br/><br/>                                            
                                        </div><br>							
                                    </div><br /> 
                                </div>	
                    ...
                    <!-- Modal: Agregar -->
                    <div id="modal_add_ri" class="modal animated fadeInDown" tabindex="-1" role="dialog" >
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                            ...
                            <form name="add_ri" id="add_ri" class="form-horizontal validate" method="post" action="./funciones/mod4_ronda_inv_add.php" enctype="multipart/form-data" >
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">  
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label>Sectores: (al menos 1)</label>   
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer d-flex center-content-end"><center>					
                                    ...
                                    <button type="button" tabindex="11" class="btn btn-dark" onclick="window.location.href='./_ronda_inv_admin.php'" tabindex="11" onclick="reiniciarFormulario()">Cancelar</button> 
                                    ...
                                    <div class="form-group-sm">
                                        <div class="row" align="center">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="hidden" id="id_ri" name="id_ri" />  
                                            </div>	
                                            <div class="col-md-3"></div>
                                        </div>								
                                    </div><br /> 
                                ...
                                <table id="dt_" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        for($j=0 ; is_array($arr_) && $j<count($arr_) ; $j++){
                                            ...
                                            $list_sect = $RondaInv->get_sect_en_RI($cur['id']);
                                            ...
                                            . '<td style="text-align:center">'. $list_sect  	    ."</td>\n"
