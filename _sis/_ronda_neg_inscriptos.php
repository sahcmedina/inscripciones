<?php	
	...
	$datos_f = array();
	$datos_f = $U->get_permisos('11',$datos[0]['fk_perfil']);
	$alta    = $datos_f[0]['alta'];
	$baja    = $datos_f[0]['baja'];
    ...
    $(document).ready(function(){                         
        ...
        $("#inscriptos").change(function(e){
            ...
            $("#resultado_busqueda").delay(700).queue(function(n) {                                                 
                $.ajax({
                type: "POST",
                url: "./funciones/mod3_ronda_neg_ajax_buscar_inscript.php",
            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                            ...
                            <div class="modal-header"><h6 class="modal-title"> Información </h6></div>
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">
                                        <div class="row">
                                            <center><label><i class="icon-warning"></i> La función permite administrar los inscriptos a una Ronda de Negocios </label></center>
                                        </div><br>
                                    </div><br /> 
                                </div>	
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="alert-text">
                                    <strong> <h6> Listado de Inscriptos a una Ronda de Negocios </h6> </strong> 
                                </div>
                            </div>
                            <div class="alert-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="inscriptos">Seleccione un evento para ver los Inscriptos</label>
                            <select id="inscriptos" name="inscriptos" class="form-select form-control-sm" tabindex="1" required>
                                <?php
							        ...
							        for ($i = 0; $i < count($arr_); $i++)
								        echo '<option value="'.$arr_[$i]['id'].'"'.'>' .$arr_[$i]['nombre']. "</option>\n";
							    ?>	  
                            </select>
                        </div>
                    </div>
