...
if (isset($_POST["id_c"]))     { $fk_evento   = $_POST["id_c"];     } else { $fk_evento   = ''; }
...
if($c1== 'er' OR $c2== 'er' OR $c3== 'er' OR $c4== 'er'){
	...
	?> <script type="text/javascript"> window.location="./funciones/mod5_conferencia_upd.php"; </script><?php		
}
?>