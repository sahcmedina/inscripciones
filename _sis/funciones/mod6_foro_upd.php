...
if (isset($_SESSION['var_id_f'])) 	    { $fk_evento  = $_SESSION['var_id_f'];       } else { $fk_evento   = ''; }
...
switch($opc){
    case 'ok':	
        ...
        $upd_e = $For->upd_evento($id_evento, $titulo, $fecha, $hora, $lugar, $insc_inicio, $insc_final);
        
        // actualizar los datos en la tabla foros
        $upd_f = $For->upd_foro($fk_evento, $disertante, $organismo, $modalidad, $cupo, $f_update, $id_user);
