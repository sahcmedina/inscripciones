<?php
	...
	if (isset($_POST["id_ri"])) 	 {$id_ri  = $_POST["id_ri"];      } else {$id_ri  ='';  }	
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row layout-top-spacing">                    
                        ...
                        <div class="modal-content">
                                ...
                                <br/>
                                <form name="mdf_reg" id="mdf_reg" class="form-horizontal validate" method="post" action="./funciones/mod4_ronda_inv_upd.php" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group-sm">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <input type="hidden" id="id_"     name="id_" value="<?php echo $id_ri ?>" >
                                            </div>
                                            <div class="col-md-5"> 
                                                    ...
                                                    <?php foreach($arr_sect as $j => $cur): ?>
                                                        <div class="col-md-6 mb-2">
                                                            <div class="form-check">    
                                                                <?php 
                                                                $id_sect= $cur['id'];
                                                                $esta   = $RondaInv->tf_existe_sector_elegido($id_ri, $id_sect);
                                                                if($esta)  $elejida= 'checked'; else $elejida= '';
                                                                ?>                                                            
                                                                <input 
                                                                    type="checkbox" name="chek[]" id="chek[]" value="<?php echo $id_sect ?>" <?php echo $elejida ?>
                                ...
                                <div class="modal-footer" style="display: flex; justify-content: center; align-items: center; flex-direction: column;"><center><br/>								
                                    <!-- <button type="button" onclick="history.back()" class="btn btn-dark" data-bs-dismiss="modal" tabindex="8"> Volver </button> -->
                                     <button type="button" class="btn btn-dark" onclick="window.location.href='./_ronda_inv_admin.php'" > Volver </button>
