<?php
    ...
    include('./funciones/mod2_inventario.php');     $Invent= new Inventario();
    include('./funciones/mod2_aratos.php');         $Arat  = new Aratos();

    if (isset($_POST["depo_elegido"])) 	{$id_depo= $_POST["depo_elegido"];    } else {$id_depo= '';	}
    if($id_depo==''){
    ...
    // Upd Inventario
    $Invent->aux_upd_deposito($id_depo);

    // Datos del inventario
    $arr_inv = array();
    $arr_inv = $Invent->gets($id_depo);

    // Datos dinamicos (Aratos)
    $arr_config_tabla = array();
    $arr_config_tabla = $Invent->gets_datos_config($id_depo);
    if(count($arr_config_tabla)> 0)  $knt_aratos = $arr_config_tabla[0]['cant_a'];
    else                                    $knt_aratos = 0;

    $arr_a   = array();
    $arr_a   = $Arat->gets_segun_dep($id_depo);
?>
                                    ...
                                    <div class="page-header">
                                        ...
                                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page"> <b><font color='red'><?php echo $nbre_depo ?></font></b> </li>
                                            </ol>
                                        </nav>
                        ...
                        <div class="col-lg-12 mx-auto layout-spacing">                            
                            <div class="statbox widget box box-shadow">                                
                                <div class="widget-content widget-content-area text-center">
                                    ...
                                    <?php if($alta == '1'){ ?>
                                        <a href="./_depositos_ingresos.php" class="btn btn-outline-success btn-icon mb-2 me-4" title="Cargar ingreso de materiales.">
                            ...
                            <form name="form_del_user" id="form_del_user" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                ...
                                <div class="modal-body with-padding">					
                                    <div class="form-group-sm">
                                        <div class="row">
                                            <label><i class="icon-warning"></i> La función permite ver el Inventario de un Deposito en particular de la empresa. </label>
                                            <br/><br/>
                                            <!-- <label><i class="icon-warning"></i> * Finalizar: El sistema agrega fecha de fin, la cual inhabilita al Arato para su uso. </label> -->
                                        </div><br>							
                                    </div><br /> 
                                </div>	
                        ...
                        <div class="col-lg-12 mx-auto layout-spacing">                            
                            <div class="statbox widget box box-shadow">                                
                                <div class="widget-content widget-content-area text-center">
                                    ...
                                    <!-- <a href="./_depositos_ingresos_todomp.php" class="btn btn-outline-success btn-icon mb-2 me-4" title="Ingresos en depósitos para Mantenimiento y/u Obras.">
                                    ...
                                    <a href="./_depositos_ingresos_x.php?i=4" class="btn btn-outline-success btn-icon mb-2 me-4" title="Ingresos solo en depósitos para Obras.">
                            ...
                            <div class="widget-content widget-content-area br-8">
                                <table id="dt_" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        for($i2= 0; $i2 < $knt_aratos; $i2++){  
                                            $tabla .= "<th style='text-align:center'> A ".$arr_a[$i2]['codigo']."    </th>";
                                        }

                                        $tabla.="</tr></thead><tbody>";			
                                        echo $tabla;
                                        for($j=0 ; is_array($arr_inv) && $j<count($arr_inv) ; $j++){
                                            $cur  = $arr_inv[$j];
                                                                                   
                                            $fila= "<tr class=\"cellColor" . ($j%2) . "\" align=\"center\" id=\"tr$j\">\n"
                                            . '<td style="text-align:center">'. $cur['codigo']        ."</td>\n"
                                            . '<td style="text-align:center">'. $cur['nombre']  	  ."</td>\n"
                                            . '<td style="text-align:center">'. $cur['M'] 	          ."</td>\n"
                                            . '<td style="text-align:center">'. $cur['P']             ."</td>\n";

                                            for($i2= 0; $i2 < $knt_aratos; $i2++){  
                                                $a_    = 'A_'.$arr_a[$i2]['id']; 
                                                $fila .= "<td style='text-align:center'> ".$cur[$a_]."    </td>";
                                            }
