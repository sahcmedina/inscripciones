<?php	
	...
	$datos_f = array();
	$datos_f = $U->get_permisos('17',$datos[0]['fk_perfil']);
	$alta    = $datos_f[0]['alta'];
	$baja    = $datos_f[0]['baja'];
...
$(document).ready(function(){    
    ...
    $("#validar_add").click(function(){
        ...
        $("#mostrar_validar_add").delay(15).queue(function(n) {                                                 
            $.ajax({
                type: "POST",
                url: "./funciones/mod6_ajax_validar_add_foro.php",                                                                                                                                                                                                    
    ...
    $("#validar_upd_sta").click(function(){
        ...
        id_usr= $("#modal_mdfSta #id_usr").val();			
	  	...
	  	$("#mostrar_validar_upd_sta").delay(15).queue(function(n) {                                                 
            $.ajax({
                type: "POST",
                url: "./funciones/mod6_ajax_validar_upd_estado_foro.php",                                                                                                                                                                                                    
                ...
                <div class="middle-content container-xxl p-0">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Foros</li>
                                            </ol>
                                        </nav>
                                    ...
                                    <form name="form_del_user" id="form_del_user" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                        <div class="modal-body with-padding">					
                                            <div class="form-group-sm">
                                                <div class="row">
                                                    <center><label><i class="icon-warning"></i> La función permite administrar Eventos, específicamente Foros y/o Summits </label></center>
                                                </div><br>							
                                            </div> 
                                        </div>	
                                        <div class="modal-footer d-flex center-content-end">					
                                            <center><button class="btn btn-dark" data-bs-dismiss="modal" tabindex="1">Cerrar</button></center>
                                        </div> 
                                    </form>
                                </div>
                            </div>
                    ...
                    <div id="modal_del" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-content" >
                            <div class="modal-content">
                                <div class="modal-header"><h6 class="modal-title"><i class="bi bi-trash" style="font-size: 1rem;"></i> Borrar Foro </h6></div>
                                <form name="formdel" id="formdel" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                    ...
                                    <div class="modal-footer d-flex center-content-end"><center>					
                                        ...
                                        <br /><br />
                                        <div id="mostrar_validar_del" ></div></center> 
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div id="modal_add" class="modal animated fadeInDown" tabindex="-1" role="dialog" >
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header"><h6 class="modal-title"><i class="bi bi-plus-circle" style="font-size: 1rem;"></i> Agregar nuevo Foro </h6></div>
                                <form name="addforo" id="addforo" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                    <div class="modal-body with-padding">					
                                        <div class="form-group-sm">
                                            <div class="row">
                                                <div class="col-md-12">
                    ...
                    <div id="modal_mdfSta" class="modal animated fadeInDown" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header"><h6 class="modal-title"><i class="bi bi-repeat" style="font-size: 1rem;"></i> Modificar Estado del Foro  </h6></div>
                                <form name="mdfsta" id="mdfsta" class="form-horizontal validate" method="post" action="#" enctype="multipart/form-data" >
                                    ...
                                    <div class="modal-footer"><center>					
                                        ...
                                        <button id="validar_upd_sta" name="validar_upd_sta" type="button" class="btn btn-success" title="Se va a validar si se puede modificar." tabindex="8"> Cambiar Estado </button>
                                        <br/><br/>
                                        <div id="mostrar_validar_upd_sta" ></div></center>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="alert-text">
                                    <strong> <h6> Listado de Foros o Summit generados </h6> </strong> 
                                </div>
                            </div>
                            <div class="alert-btn">
                                <?php if($alta == '1') { ?>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">          
                                <div class="modal-header">
                                    <h6 class="modal-title"><i class="bi bi-pencil" style="font-size: 1rem;"></i> Editar datos del Foro </h6>
                                </div>
                                
                                <form name="formedt" id="formedt" class="form-horizontal validate" action="#" method="post" enctype="multipart/form-data" >
                                    <div class="modal-body with-padding">
                                        <div class="form-group-sm">
                                            <div class="row">
                                                <div class="col-md-12">
                                    ...
                                    <div class="modal-footer"><center>
                                        <button type="button" tabindex="11" class="btn btn-dark" onclick="window.location.href='./_foros_.php'" tabindex="11">Cancelar</button>
