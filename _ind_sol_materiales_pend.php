                            ...
                            <table id="dt_" class="table dt-table-hover" style="width:100%">
                                ...
                                <?php
                                    $tabla= "<thead><tr class=\"rowHeaders\">			
                                            ...
                                            <th style='text-align:center'> Solicitado el?	</th></th>";
                                    $tabla.="</tr></thead><tbody>";			
                                    echo $tabla;
                                    for($j=0 ; is_array($arr_solicPorTec) && $j<count($arr_solicPorTec) ; $j++){
                                        $cur  = $arr_solicPorTec[$j];
