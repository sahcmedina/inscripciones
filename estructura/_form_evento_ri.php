...
if (isset($_SESSION['ses_fk_evento'])) { $fk_id= $_SESSION['ses_fk_evento']; } else { $fk_id= ''; }

include_once("_sis/funciones/pais_prov.php");       $Pais= new Pais_prov();
// include_once('_sis/funciones/mod4_sectores.php');   $Sectores = new Sectores();
...
//$arr_sectores= array();
//$arr_sectores= $Sectores->gets();
// obtener los sectores asociados a la RI
$arr_sectores= array();
$arr_sectores= $RI->gets_sectores_segun_ri($fk_id);
...
<div class="u-form u-form-1">
  ...
  <form name='form' id='form' method="POST" action="./estructura/inscriptos_form_ri.php" class="u-inner-form">

    <!-- Productos -->
    <div class="u-form-checkbox-group u-form-group u-form-group-1">
      <label class="u-label">Seleccione el Sector en el que desea Invertir u Ofertar</label>
      <div class="u-form-checkbox-group-wrapper"> 
        <?php for($i=0 ; $i<count($arr_sectores) ; $i++){ ?>
    ...
    <div class="u-form-row">
      ...
      <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-2">
        ...
        <div class="u-form-select-wrapper">
          <select id="i_o" name="i_o" class="u-border-1 u-border-custom-color-3 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-montserrat u-input u-input-rectangle u-none u-input-1">
            <option value="i" data-calc="">Inversor</option>
            <option value="o" data-calc="">Oferente</option>
          </select>
