...
$arr_inscrip = $Con->tf_dni_inscripto_evento($dni, $fk_evento); // ya esta inscripto ???
if(count($arr_inscrip) > 0){
  ...
  $arr_inscrip = $Con->get_datos_dni_inscripto($dni);
  if(count($arr_inscrip)>0){
...
<div class="u-form u-form-1">
  ...
  <form name="formInsc" id="formInsc" method="post" action="./estructura/inscriptos_form_c.php" class="u-inner-form" role="form" enctype="multipart/form-data">  
    ...
    <div class="u-form-row">
      ...
      <center>
        <h2 class="u-align-center u-custom-font u-font-montserrat u-text u-text-default u-text-1"><span style="font-weight: 300;">Ya se encuentra Inscripto en esta Conferencia</span></h2>
      </center>
      </div>
