...
<div class="u-form u-form-1">
  ...
  <form method="POST" action="./estructura/inscriptos_form_rn.php" class="u-inner-form">
    ...
    <div class="u-form-row">
      ...
      <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-2">
        ...
        <div class="u-form-select-wrapper">
          <select id="select-abbf" name="select" class="u-border-1 u-border-custom-color-3 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-montserrat u-input u-input-rectangle u-none u-input-1">
